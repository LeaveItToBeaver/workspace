...
import { useUsers, useCreateUser, useUpdateUser, useDeleteUser, useDeleteUsers } from '@/features/users/hooks';
...
export function UsersPage() {
    ...
    const handleUpdate = async (id: string, updates: Partial<{ name: string; zipCode: string }>) => {
                ...
                <Card title="Users" className="">
                    {isLoading ? (
                        ...
                        <UsersTable
                            ...
                            onBulkDelete={(ids: string[]) => deleteUsers.mutate(ids)}
